      ...
      <div className="fixed top-0 left-0 w-full h-full z-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black">
          <div className="flex flex-col items-center gap-">
            ...
            <div className="glassback2">
              <h1 className="text-gray-300 font-MuktaVaani text-5xl my-10">
                Create an account
              </h1>
              <div className="flex flex-col gap-14">
                <div className="">
                  <p className="text-stone-200 text-2xl font-light font-['Mukta Vaani']">
                    Email address
                  </p>
            ...
            <a
              ...
              className="flex gap-5 items-center justify-center w-[23rem] h-16 bg-neutral-300  bg-opacity-10 rounded-[48px] border border-white border-opacity-10 backdrop-blur-[34px]"
            >
